...
function CallLogTable() {
  ...
  // Fetch call logs for the selected employee and apply filters
  useEffect(() => {
  ...
  const formatDuration = (totalSeconds) => {
    ...
    return `${minutes}:${seconds < 10 ? '0' : ''}${seconds}`; // Ensures that seconds always have two digits
  };

  // Filter and search logic for displayed call logs
